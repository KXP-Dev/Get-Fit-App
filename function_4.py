...
def add_exercise(exercises):
    ...
    try:
        with open(exercises, "a", newline='') as open_exercises:
            ...
            exercise_name = get_string_input("Enter the name of the exercise: ")
            exercise_date = get_date_input("Enter the date of the exercise (dd/mm/yyyy): ")
            sets = get_float_input("Enter the number of sets: ")
            repetitions = get_string_input("Enter the number of repetitions (Each set is seperated by slashes): ")
